...
const OtherChanges = () => (
    <>
        ...
        <TextPrimary>
            {localize(
                "_t_Besides an improved, modern look, we’ve introduced a new trade type called multipliers and a peer-to-peer payment facility (DP2P) that's available on our website and as a mobile app.  We’re also creating more resources to help you improve your trading skills._t_",
            )}
        </TextPrimary>
        <TextPrimary>
            {localize(
                '_t_One more thing: We’ve rebranded our social media profiles to @Derivdotcom on Facebook, Instagram, and Twitter. Like and follow us to stay updated with our latest news._t_',
            )}
        </TextPrimary>
    </>
)
