    ...
    <GridContainer>
        <GridWrapper columns="repeat(3, 1fr)" column_gap="13rem" row_gap="10rem">
            <Col
                ...
                content={
                    <Localize translate_text="_t_Deriv Group – the owners of the Deriv and Binary.com brands – has a history that dates back to 1999 when we laid the groundwork for the world’s first fixed-odds trading service. Since then, we have grown from strength to strength, garnering the trust of traders around the world._t_" />
                }
            />
            <Col
            ...
            <Col
                ...
                content={
                    <Localize translate_text="_t_Deriv does not use your money for its business interests and you are allowed to withdraw your money at any time. All your money is segregated and held in secure financial institutions. In this way, in the unlikely event of Deriv becoming insolvent, all your money will be returned to you because it is never merged with ours._t_" />
                }
            />
            <Col
                Icon={Risk}
            ...
            <Col
                ...
                content={
                    <Localize translate_text="_t_Deriv makes it easy for anyone to start trading, understand risk, and make better trading decisions. Our tools and platforms have clear and simple instructions and are intuitively easy to navigate. We also regularly provide market news, analysis, webinars, ebooks, video tutorials and help centre articles to help you stay informed and become a better trader._t_" />
                }
            />
            <Col
                Icon={Safety}
                ...
                content={
                    <Localize translate_text="_t_At Deriv, we enforce best-in-class security measures such as SSL encryption to protect your account and personal data._t_" />
                }
            />
        </GridWrapper>
    </GridContainer>
